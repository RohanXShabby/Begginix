...
export const portfolioItems: PortfolioItem[] = [
    {
        ...
        year: 2025,
        longDescription: 'We created a comprehensive brand identity system for TechStart Inc., a cutting-edge technology startup focused on AI solutions. The project involved developing a modern, scalable visual identity that would grow with the company while maintaining consistency across all touchpoints.',
        challenges: ['Creating a brand that appeals to both tech-savvy developers and business stakeholders', 'Ensuring scalability for future product lines', 'Differentiating from competitors in the crowded AI space'],
        solutions: ['Developed a minimalist logo system with multiple variations', 'Created a flexible color palette with primary and secondary options', 'Established comprehensive brand guidelines for consistent application'],
        technologies: ['Adobe Illustrator', 'Adobe Photoshop', 'Figma', 'Brand Guidelines Documentation'],
        duration: '6 weeks',
